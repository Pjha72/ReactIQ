        ...
        <section class="text-gray-600 body-font">
          <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
            <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              <h1 class="title-font sm:text-4xl text-sm mb-4 font-sm text-gray-400 font-mono hover:text-gray-700">
                Welcome To
              ...
              <p class="mb-8 leading-relaxed text-justify text-gray-600 hover:text-gray-800 font-amarnath">
                ...
                understanding, we offer a variety of resources to help you
                succeed.
              </p>
              <div class="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
                <button class="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none hover:shadow-xl">
                  <svg
                  ...
                  <span class="ml-4 flex items-start flex-col leading-none">
                    <span class="text-xs text-gray-900 mb-1">GET IT ON</span>
                ...
                <button class="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none hover:shadow-xl">
                  ...
                  <span class="ml-4 flex items-start flex-col leading-none">
                    <span class="text-xs text-gray-900 mb-1">
                      Download on the
                    </span>
                    <span class="title-font font-medium text-gray-900">
                      App Store
            ...
            <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
              <video class="h-full w-full rounded-xl" autoPlay loop muted>
